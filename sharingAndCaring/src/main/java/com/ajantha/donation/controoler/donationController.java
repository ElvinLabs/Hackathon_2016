package com.ajantha.donation.controoler;

import com.ajantha.donation.model.DonationPost;
import com.ajantha.donation.service.DonationService;
...
public class donationController {
    ...
    @RequestMapping(value = {"/v1/rest/donations/{postId}"}, method = RequestMethod.PUT)
